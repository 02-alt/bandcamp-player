...
enum MetadataPrefs {
    ...
    private static let autoKey = "cabin.autoEnrichImports"
    ...
    private static let sourceKey = "cabin.creditsSource"
...
struct MetadataService {
    ...
    private static let userAgent = "Cabin/0.1 (+https://github.com/cabin-app)"
