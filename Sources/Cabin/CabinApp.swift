...
final class AppState: ObservableObject {
    ...
    @Published var crateStyle: CrateStyle =
        CrateStyle(rawValue: UserDefaults.standard.string(forKey: "cabin.crateStyle") ?? "") ?? .coverflow {
        didSet { UserDefaults.standard.set(crateStyle.rawValue, forKey: "cabin.crateStyle") }
    }

    /// Which floating mini-player look to use. Persisted.
    @Published var miniPlayerStyle: MiniPlayerStyle =
        MiniPlayerStyle(rawValue: UserDefaults.standard.string(forKey: "cabin.miniStyle") ?? "") ?? .cover {
        didSet {
            UserDefaults.standard.set(miniPlayerStyle.rawValue, forKey: "cabin.miniStyle")
    ...
    @Published var nowPlayingStyle: NowPlayingStyle =
        NowPlayingStyle(rawValue: UserDefaults.standard.string(forKey: "cabin.nowPlayingStyle") ?? "") ?? .flat {
        didSet { UserDefaults.standard.set(nowPlayingStyle.rawValue, forKey: "cabin.nowPlayingStyle") }
    }
    ...
    private static let hiddenKey = "cabin.hiddenBandcamp"
    ...
    private static let celebratedKey = "cabin.celebratedAlbums"
    ...
    private static let unboxInitKey = "cabin.unboxInitialized"
    ...
    init() {
        ...
        if ProcessInfo.processInfo.environment["CABIN_DEMO_EMPTY"] == "1" {
            identity = nil
            rebuildVisible()
    ...
    private static let scrapedKey = "cabin.genreScrapedURLs.v3"
