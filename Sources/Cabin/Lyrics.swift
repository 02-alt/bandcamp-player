...
enum LyricsService {
    ...
    private static let userAgent = "Cabin (+https://github.com/02-alt/bandcamp-player)"
...
final class LyricsStore {
    ...
    private static let ioQueue = DispatchQueue(label: "com.cabin.lyrics.io", qos: .utility)
