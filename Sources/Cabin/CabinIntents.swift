...
struct PlayPauseIntent: AppIntent {
    ...
    static let description = IntentDescription("Toggle playback in Cabin.")
...
struct WhatsPlayingIntent: AppIntent {
    ...
    static let description = IntentDescription("Return the track playing in Cabin.")
...
@available(macOS 13.0, *)
struct CabinShortcuts: AppShortcutsProvider {
