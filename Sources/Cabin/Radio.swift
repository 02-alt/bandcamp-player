...
enum RadioPrefs {
    ...
    static var moodOnline: Bool {
        get { UserDefaults.standard.bool(forKey: "cabin.moodOnline") }
        set { UserDefaults.standard.set(newValue, forKey: "cabin.moodOnline") }
    }

    /// "Auto-DJ": while a station plays, blend tracks with a beat-matched crossfade.
    static var autoDJ: Bool {
        get { UserDefaults.standard.bool(forKey: "cabin.autoDJ") }
        set { UserDefaults.standard.set(newValue, forKey: "cabin.autoDJ") }
    }
}
